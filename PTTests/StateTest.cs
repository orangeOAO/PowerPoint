...
namespace PTTests
{
    ...
    public class StateTest
    {
        ...
        public void ResizeState_PressedPointerTest()
        {
            ...
            resizeState.PressedPointer(_mockModel.Object, _testPoint);
        ...
        public void Select_MovedPointerTest()
        {
            ...
            selectState.MovedPointer(_mockModel.Object, point);
        ...
        public void Resize_MovedPointerTest()
        {
            var resizeState = new ResizeState();
            var point = new Point(10, 10);
            resizeState.MovedPointer(_mockModel.Object, point);
        ...
        public void Drawing_MovedPointerTest()
        {
            ...
            drawingState.MovedPointer(_mockModel.Object, point);
        ...
        public void Point_MovedPointerTest()
        {
            ...
            pointState.MovedPointer(_mockModel.Object, point);
