...
namespace PPTests
{
    ...
    public class StateTest
    {
        ...
        public void Drawing_DrawTest()
        {
            ...
            PrivateObject privateState = new PrivateObject(_state);

            privateState.SetField("_isPressed", true);

            System.Drawing.Graphics graphics = System.Drawing.Graphics.FromImage(new Bitmap(100, 100));
            _state.Draw(_mockModel.Object, graphics);
        ...
        public void PointState_PressedPointerTest()
        {
            ...
            _mockModel.Object._selectShapeIndex = 0;
            pointState.PressedPointer(_mockModel.Object, _testPoint);
            _mockModel.Verify(m => m.SetState(It.IsAny<SelectState>()), Times.Once);
        }
        ...
        public void ResizeState_PressedPointerTest()
        {
            ...
            resizeState.PressedPointer(_mockModel.Object, testPoint);
            _mockModel.Verify(m => m.PressedPointer(It.IsAny<Point>(), It.IsAny<ShapeType>()), Times.Never);
        }
        ...
        public void Select_MovedPointerTest()
        {
            ...
            _mockModel.Setup(m => m.ChangeToResizeMode(It.IsAny<Point>())).Returns(true);
            selectState.MovedPointer(_mockModel.Object, point, false);

            _mockModel.Verify(m => m.SetState(It.IsAny<ResizeState>()), Times.Once);
        ...
        public void Resize_MovedPointerTest()
        {
            ...
            resizeState.MovedPointer(_mockModel.Object, point, false);
            _mockModel.Verify(m => m.SetState(It.IsAny<SelectState>()), Times.Once);
        ...
        public void Point_MovedPointerTest()
        {
            ...
            _mockModel.Verify(m => m.MoveShape(It.IsAny<Point>()), Times.Never);
        ...
        public void Drawing_ReleasedPointerTest()
        {
            ...
            PrivateObject privateState = new PrivateObject(state);
